<template>
  <Panel>
    <div class="flex-row align-center justify-space-around flex-wrap-reverse w-80">
      <div>
        <h1 id="h1">Hi I'm</h1>
        <h2 id="h2">Evann</h2>
...
onMounted(() => {
  createObserver(document.getElementById('profile-picture'), "animate-profile-picture");
