...
This personal website has been built using Astro and I use Markdown for my blog posts. For my [previous article](./2024-08-27_how-I-adapted-pokemon-emerald-to-my-needs.mdx) I needed to create a code block that one could copy the content to the clipboard.
